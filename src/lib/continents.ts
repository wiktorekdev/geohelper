...
const ISO_TO_CONTINENT: Record<string, string> = {
  ...
  no: "Europe", pl: "Europe", pt: "Europe", ro: "Europe", sm: "Europe", rs: "Europe",
  sk: "Europe", si: "Europe", es: "Europe", se: "Europe", ch: "Europe", ua: "Europe",
  gb: "Europe", va: "Europe", ru: "Europe",
  ...
  vc: "North America", sx: "North America", tt: "North America", tc: "North America",
  us: "North America", vi: "North America",
...
export function continentFrom(countryCode?: string, lat?: number, lng?: number): string | undefined {
  if (countryCode) {
